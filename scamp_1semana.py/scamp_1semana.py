...
Data   = read('C1.MT12.HHZ.2017.182-188.mseed')
...
cc_suma        = mp.selfjoin_sum(Data[0].data*1e8, sublen, threads=32, threshold=0.9)   # Cuántas veces una subsecuencia tiene correlación alta con otras subsecuencias
