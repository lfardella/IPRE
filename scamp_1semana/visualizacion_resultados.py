...
data = read('../../Datos/2017/Julio/C1.MT12.HHZ.2017.182-188.mseed')
signal = data[0].data
stats = data[0].stats
...
# Crear un eje de tiempo en días (para considerar 7 días)
...
plt.savefig("results_plot_7days_09.png", dpi=300, bbox_inches='tight')
plt.show()
